...
ActiveRecord::Schema.define(version: 20180927222045) do
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.index ["latitude"], name: "index_accounts_on_latitude"
    t.index ["longitude"], name: "index_accounts_on_longitude"
